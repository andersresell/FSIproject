...
namespace solid {
    ...
    public:
        ...
        Cell point2ind(double x, double y) const { return {(int)(x/dx + 1.5),(int)(y/dy + 1.5)};} //rounding a point down to nerest cell index
        ...
        bool point_inside(Point p); //Check wether a poins is inside the solid boundary
