...
class FSI_Solver
{
  ...
  public:
    ...
    void set_timesteps(int n_timesteps)
    {
        stopping_crit = {StoppingCrit::Timesteps, n_timesteps};
    }
    void set_endtime(double t_end)
    {
        stopping_crit = {StoppingCrit::Time, t_end};
    }
    void set_convergence(double tol = 1e-6)
    {
        stopping_crit = {StoppingCrit::Convergence, tol};
    }
