...
void set_initial_cond_shock_tube_experiment(vec4 *U, int ni, int nj, double L_x, double driver_length, vec4 V_l,
                                            vec4 V_r)
{
...
void set_initial_cond_pressure_bubble(vec4 *U, int ni, int nj, double L_x, double L_y, double x_c, double y_c,
                                      double radius)
{
    double rho_low = 1.2;
    double p_low = 1e5;
...
namespace solid
{
std::vector<solid::Point> generate_wedge(double l, double half_angle_deg, double x_tip, double y_tip)
{
...
std::vector<solid::Point> generate_diamond_wedge(double l, double half_angle_deg, double x_center, double y_center)
{
...
std::vector<solid::Point> generate_rectangle(double W, double H, double rotation_angle_deg, double x_center,
                                             double y_center)
{
    ...
    { // rotating all points and tranlating by the center
