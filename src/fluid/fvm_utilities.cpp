...
ExternalBCs::ExternalBCs(int ni, int nj, BC_Type west, BC_Type east, BC_Type south, BC_Type north, double M_inf,
                         double p_inf, double rho_inf, string history_output_west_folder)
